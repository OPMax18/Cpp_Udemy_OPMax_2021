...
/*
   Serial time in ms: 4.59 - 18.16ms, 18.78ms, 18.45ms, 18.2ms
2: OpenMP time in ms: 3.31 - 10.19ms
4: OpenMP time in ms: 2.80 - 11.42ms
6: OpenMP time in ms: 2.70 - 9.88ms
8: OpenMP time in ms: 2.71 - 9.54ms
*/
int main()
{
    // SETUP
